...
export function __wbg_backgroundinfo_free(a: number): void;
export function __wbg_get_backgroundinfo_priority(a: number): number;
export function __wbg_set_backgroundinfo_priority(a: number, b: number): void;
export function __wbg_get_backgroundinfo_character_base_block(a: number): number;
export function __wbg_set_backgroundinfo_character_base_block(a: number, b: number): void;
export function __wbg_get_backgroundinfo_mosaic(a: number): number;
export function __wbg_set_backgroundinfo_mosaic(a: number, b: number): void;
export function __wbg_get_backgroundinfo_use_256_colors(a: number): number;
export function __wbg_set_backgroundinfo_use_256_colors(a: number, b: number): void;
export function __wbg_get_backgroundinfo_screen_base_block(a: number): number;
export function __wbg_set_backgroundinfo_screen_base_block(a: number, b: number): void;
export function __wbg_get_backgroundinfo_wraparound(a: number): number;
export function __wbg_set_backgroundinfo_wraparound(a: number, b: number): void;
export function __wbg_get_backgroundinfo_screen_size(a: number): number;
export function __wbg_set_backgroundinfo_screen_size(a: number, b: number): void;
export function ppu_bg_tilemap(a: number, b: number, c: number): void;
export function ppu_debug_tiles(a: number, b: number, c: number): void;
export function gbacore_debug_bg_tilemap(a: number, b: number, c: number): void;
export function gbacore_draw_palettes(a: number, b: number, c: number): void;
export function gbacore_draw_tiles(a: number, b: number, c: number, d: number, e: number): void;
export function gbacore_background_info(a: number, b: number): number;
export function gbacore_background_mode(a: number): number;
export function gbacore_new(): number;
export function gbacore_pc_history(a: number, b: number): void;
...
export function gbacore_tilemap(a: number, b: number): number;
export function gbacore_ie_reg(a: number): number;
export function gbacore_if_reg(a: number): number;
