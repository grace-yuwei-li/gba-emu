...
*/
export function to_canvas_binary_data(input) {
    const ptr0 = passArray8ToWasm0(input, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.to_canvas_binary_data(ptr0, len0);
...
export class CpuDetails {
    ...
    */
    get pc() {
        const ret = wasm.__wbg_get_cpudetails_pc(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    * @param {number} arg0
    */
    set pc(arg0) {
        wasm.__wbg_set_cpudetails_pc(this.__wbg_ptr, arg0);
    }
}
/**
*/
export class GbaCore {
    ...
    */
    breakpoints() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.gbacore_breakpoints(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    add_breakpoint(breakpoint) {
        wasm.gbacore_add_breakpoint(this.__wbg_ptr, breakpoint);
    }
    /**
    * @param {number} breakpoint
    */
    remove_breakpoint(breakpoint) {
        wasm.gbacore_remove_breakpoint(this.__wbg_ptr, breakpoint);
    }
    /**
